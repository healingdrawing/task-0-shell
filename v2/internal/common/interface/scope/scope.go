...
// Package scope defines the interface for penishell's first-class environments and objects.
package scope
...
// I (scope) is the interface for penishell's first-class environments and objects.
type I interface {
	cell.I
