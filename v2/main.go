...
import (
	...
	"penishell/internal/engine"
	"penishell/internal/reader"
	"penishell/internal/system/cache"
	"penishell/internal/system/history"
	"penishell/internal/system/job"
	"penishell/internal/system/options"
...
func main() {
	...
	if options.Version() {
		println("penishell. \"The air freshener for local stench\" edition")
		return
	}
